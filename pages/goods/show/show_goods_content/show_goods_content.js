...
Page({
  ...
  onShareAppMessage: function () {
    var pathUrl = "";
    if (goodsId) {
      pathUrl = '/pages/goods/show/show_goods_content/show_goods_content?goods_id=' + goodsId + "&channel_id=" + channelId
    } else if (packageId) {
      pathUrl = '/pages/goods/show/show_goods_content/show_goods_content?package_id=' + goodsId + "&channel_id=" + channelId
    }
    return {
      title: '圆满人生公共殡葬服务平台',
